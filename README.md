## Icomoon - src/assets/fonts/icons

Our icons are generated by Icomoon tool - https://icomoon.io/
In order to add/change icons import selection.json in Icomoon, add your new icons and export it again.
Remember to copy selection.json file as well so it is updated.

Below Razzle documentation:
